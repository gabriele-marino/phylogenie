...
| `3.BDSS-Trees.yaml` | You want to simulate trees under a birth–death with superspreading (BDSS) model. |
...
| `5.BD-CT-Trees.yaml` | You want to add contact tracing (CT) to your tree simulations. |
| `6.BD-MSAs.yaml` | You want to simulate multiple sequence alignments (MSAs). |
